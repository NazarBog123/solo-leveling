	...
	return (
		<svg width='1045' height='1045' viewBox='0 0 1045 1045' fill='none' xmlns='http://www.w3.org/2000/svg'>
			...
			<g filter='url(#clockGlow)'>
				<rect x='549.301' y='987.3' width='54' height='124' rx='15' transform='rotate(180 549.301 987.3)' stroke='#EEF2F6' stroke-width='6' />
				<rect x='506.301' y='877.3' width='32' height='96' style={{ opacity: hoursLeft >= 1 ? 1 : 0 }} rx='10' fill='#EEF2F6' />
				<rect x='668.73' y='964.467' width='54' height='124' rx='15' transform='rotate(165 668.73 964.467)' stroke='#EEF2F6' stroke-width='6' />
				...
				<rect x='778.183' y='911.502' width='54' height='124' rx='15' transform='rotate(150 778.183 911.502)' stroke='#EEF2F6' stroke-width='6' />
				...
				<rect x='870.197' y='832.012' width='54' height='124' rx='15' transform='rotate(135 870.197 832.012)' stroke='#EEF2F6' stroke-width='6' />
				...
				<rect x='938.503' y='731.417' width='54' height='124' rx='15' transform='rotate(120 938.503 731.417)' stroke='#EEF2F6' stroke-width='6' />
				...
				<rect x='978.443' y='616.571' width='54' height='124' rx='15' transform='rotate(105 978.443 616.571)' stroke='#EEF2F6' stroke-width='6' />
				...
				<rect x='987.301' y='495.3' width='54' height='124' rx='15' transform='rotate(90 987.301 495.3)' stroke='#EEF2F6' stroke-width='6' />
				...
				<rect x='964.469' y='375.87' width='54' height='124' rx='15' transform='rotate(75 964.469 375.87)' stroke='#EEF2F6' stroke-width='6' />
				...
				<rect x='911.503' y='266.417' width='54' height='124' rx='15' transform='rotate(60 911.503 266.417)' stroke='#EEF2F6' stroke-width='6' />
				...
				<rect x='832.014' y='174.403' width='54' height='124' rx='15' transform='rotate(45 832.014 174.403)' stroke='#EEF2F6' stroke-width='6' />
				...
				<rect x='731.418' y='106.098' width='54' height='124' rx='15' transform='rotate(30 731.418 106.098)' stroke='#EEF2F6' stroke-width='6' />
				...
				<rect x='616.572' y='66.1557' width='54' height='124' rx='15' transform='rotate(15 616.572 66.1557)' stroke='#EEF2F6' stroke-width='6' />
				...
				<rect x='495.301' y='57.2998' width='54' height='124' rx='15' stroke='#EEF2F6' stroke-width='6' />
				...
				<rect x='375.872' y='80.133' width='54' height='124' rx='15' transform='rotate(-15 375.872 80.133)' stroke='#EEF2F6' stroke-width='6' />
				...
				<rect x='266.418' y='133.098' width='54' height='124' rx='15' transform='rotate(-30 266.418 133.098)' stroke='#EEF2F6' stroke-width='6' />
				...
				<rect x='174.405' y='212.588' width='54' height='124' rx='15' transform='rotate(-45 174.405 212.588)' stroke='#EEF2F6' stroke-width='6' />
				...
				<rect x='106.098' y='313.182' width='54' height='124' rx='15' transform='rotate(-60 106.098 313.182)' stroke='#EEF2F6' stroke-width='6' />
				...
				<rect x='66.1586' y='428.029' width='54' height='124' rx='15' transform='rotate(-75 66.1586 428.029)' stroke='#EEF2F6' stroke-width='6' />
				...
				<rect x='57.3008' y='549.3' width='54' height='124' rx='15' transform='rotate(-90 57.3008 549.3)' stroke='#EEF2F6' stroke-width='6' />
				...
				<rect x='80.133' y='668.73' width='54' height='124' rx='15' transform='rotate(-105 80.133 668.73)' stroke='#EEF2F6' stroke-width='6' />
				...
				<rect x='133.098' y='778.182' width='54' height='124' rx='15' transform='rotate(-120 133.098 778.182)' stroke='#EEF2F6' stroke-width='6' />
				...
				<rect x='212.588' y='870.197' width='54' height='124' rx='15' transform='rotate(-135 212.588 870.197)' stroke='#EEF2F6' stroke-width='6' />
				...
				<rect x='313.183' y='938.502' width='54' height='124' rx='15' transform='rotate(-150 313.183 938.502)' stroke='#EEF2F6' stroke-width='6' />
				...
				<rect x='428.029' y='978.444' width='54' height='124' rx='15' transform='rotate(-165 428.029 978.444)' stroke='#EEF2F6' stroke-width='6' />
